...
const Features = () => {
  ...
  return (
    <>
    <Box className={styled.feature_mainContainer}> 
        <Box className={styled.AutoScroll}>
            {/* Scroll Items */}
            <Box className={styled.scrollTags}>
                <Box className={styled.scroll_items}>
                  ...
                  <h3>Intuitive time tracking and powerful insights that help your team thrive.</h3>
                    <Box className={styled.tags}>
                       <Box className={styled.tag_item} onClick={()=>handleScroll(timeRef.current)}>
                        ...
                        <Box className={styled.tag_item} onClick={()=>handleScroll(reportRef.current)}>
                     ...
                     <Box className={styled.tag_item} onClick={()=>handleScroll(invoiceRef.current)}>
                ...
                {/* Items-Section */}
                 <Box className={styled.items}>
                    {/* Timetracking */}
                   <Box ref={timeRef} className={styled.timetracking}>
                    <Box className={styled.timetrack_flex}>
                        <Box>
                            <h1>Time tracking </h1>
                            <h3>
                    ...
                    <Box className={styled.banner_flex}>
                    <Box className={styled.banner_flexitems}>
                      <Box>
                 ...
                 {/* banner Genevieve */}
                     <Box className={styled.quote_banner}>
                     ...
                     </Box> {/* //quote-banner end */}
                     {/* Report & analysis */}
                     <Box ref={reportRef} className={styled.report_section}>
                       <Box className={styled.report_flexbox}>
                        <Box>
                        ...
                        <Box>
                         ...
                         {/* banner-flex items */}
                         <Box className={styled.report_flex}>
                    <Box className={styled.report_flexitems}>
                      <Box>
                    ...
                    <Box className={styled.report_flexitems}>
                     ...
                     </Box> {/* Report & analysis section end */}
                     {/* banner Noah */}
                     <Box className={styled.quote_banner}>
                     ...
                     {/* Invoicing & payments */}
                     <Box ref={invoiceRef} className={styled.report_section} style={{
                      border:"none"
                     }}>
                       <Box className={styled.report_flexbox}>
                        <Box>
